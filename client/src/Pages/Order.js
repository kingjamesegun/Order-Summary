        ...
        return ( 
            <div className="order container">
                    ...
                    <div className="col-lg-6 col-md-6">
                        ...
                        <div className="order__customer">
                            <img 
                                src={ProfilePic} 
                                alt="profile__pic" 
                                style={{height: 40, width: 40, borderRadius: "50%", marginRight: 10, animationDuration: "2s"}}
                ...
                <div className="order__items mt-4 mb-4">
                    <Header
                        header="ITEMS OF ORDER" 
                    />
                    <Card/>
                </div>
                <div className="order__summary">
                    <Header
                        header="ORDER SUMMARRY"
                    />
                    <div className="row">
                        <div className="col-lg-4 col-md-4">
                            <div className="summary">
                                <div className="summary__item">
                                    Items' Total : <span>{this.state.total} items</span>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-4">
                            <div className="summary">
                                <div className="summary__item">
                                   Tax : <span> {this.state.items.reduce((totalTax, tax)=>(
                                       totalTax + tax.tax_pct
                                   ), 0)}%  
                                   </span>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-4">
                            <div className="summary">
                                <div className="summary__item">
                                    Total Bill: <span>INR {this.state.items.reduce((sum, i)=>(
               ...
               </div> : <div className="spinner-grow spinner" role="status">
